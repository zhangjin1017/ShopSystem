...
public class StaticPeram {
    ...
    // 替换成你的AK (产品密)
    final static String accessKeyId = "LTAI4GBdGHXNtitQvk81E6Ci";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
    final static String accessKeySecret = "veATPMtvUDrYeHuOaCHQe53WOGnARS";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    // 必填:短信签名-可在短信控制台中找到
    final static String SignName = "商城管理系统";// 阿里云配置你自己的短信签名填入
    // 必填:短信模板-可在短信控制台中找到
    final static String TemplateCode = "SMS_193249189"; // 阿里云配置你自己的短信模板填入
}
